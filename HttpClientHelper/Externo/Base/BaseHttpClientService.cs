...
public abstract class BaseHttpClientService : IBaseHttpClientService
{
    ...
    public async Task<TResult> GetAsync<TResult>(string url, Dictionary<string, string> headers = null) where TResult : ApiResult
    {
