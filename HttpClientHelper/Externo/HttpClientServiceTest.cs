...
public class HttpClientServiceTest : BaseHttpClientService, IHttpClientServiceTest
{
    public HttpClientServiceTest(IHttpClientFactory httpClientFactory) 
        : base(httpClientFactory.CreateClient("InvestimentGeneral"))
    {
    }
